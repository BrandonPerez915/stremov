...
class MovieHero extends HTMLElement {
  ...
  _render() {
    ...
    this.shadowRoot.getElementById('btn-details').onclick = () => {
      const imdbId = this.getAttribute('data-imdb-id') || 'tt0848228';
      window.location.href = `/frontend/views/movie.html?id=${imdbId}`;
    };
